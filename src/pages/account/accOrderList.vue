  ...
  <div id="accOrderList">
    ...
    <el-form ref="form" v-model="orderForm" label-width="120px" size="medium">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="服务伙伴：">
            <el-input v-model="orderForm.partner" placeholder="请输入关键字"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="伙伴推荐编码：">
            <el-input v-model="orderForm.encoode" placeholder="请输入关键字"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
...
<style type="text/css">
  #accOrderList .el-form{
    padding-top: 24px;
  }
  #accOrderList .el-input--medium .el-input__inner{
    width: 256px;
    height: 32px;
  }
  #accOrderList .el-range-editor--medium.el-input__inner {
    width: 256px;
    height: 32px;
  }
  #accOrderList .el-table--fit{
    padding: 0 24px;
    background-color: #fff;
  }
  #accOrderList .el-table tr {
    font-size:14px;
  ...
  #accOrderList .el-table__header th, .el-table__header tr {
